...
const uri = 'mongodb+srv://AmanKumar636:MedBed%40123@medbed.5skjh.mongodb.net/?retryWrites=true&w=majority&appName=MedBed'; // Replace with your actual MongoDB URI
